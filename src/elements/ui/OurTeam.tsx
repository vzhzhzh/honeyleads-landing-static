  ...
  return (
    <>
      <Container className="flex items-center md:mt-23 md:block">
        <div className="xs:mt-50 lg:mt-70">
          <div className="text-50 leading-60 text-[#373773] max-w-[52.438rem] font-semibold xs:text-22 xs:leading-27">
            Наша команда - <span className="text-[#28D2AE]">это Digital маркетологи мирового уровня</span>
          </div>
          <div className="max-w-[42.125rem] text-26 text-[#373773] mt-35 xs:text-14 xs:leading-17">
