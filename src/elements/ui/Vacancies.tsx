        ...
        <div className="flex md:block md:relative">
          <div className="">
            <div className="relative flex">
              <h2 className="text-38 leading-60 font-semibold text-purple inline xs:text-22 xs:leading-26">
            ...
            <div className="text-26 leading-31 font-medium text-purple/70 mt-15 xs:text-14 xs:leading-17">
            ...
            <div className="flex flex-wrap gap-30 mt-85 font-semibold text-21 leading-37 text-white md:gap-x-60 xs:text-12 xs:leading-18 xs:gap-10 xs:mt-15">
              {tasks.map((text, index) => (
                <div key={index} className="bg-[#FF7143] rounded-full py-15 px-50 xs:py-7 xs:px-30">
                  {text}
                </div>
              ))}
            </div>
          ...
          <img className="max-w-fit mx-auto sm:hidden self-end" src={`/images/vacancyWoman.png`} alt="" />
          <div className="hidden relative sm:block">
            <img
              className="max-w-fit md:mx-auto"
              src={`/images/${(width > 769 && 'vacancyWoman.png') || 'vacancyWomanMobile.png'}`}
              alt=""
            />
