  ...
  return (
    <div className="bg-ats bg-cover">
      <Container className="py-80 xs:py-40">
        <div className="text-[#373773] text-50 leading-60 font-semibold max-w-[38.063rem] xs:text-22 xs:leading-27 ">
        ...
        <div className="grid grid-cols-2 gap-x-30 flex text-20 mt-17 md:block">
          <div className=" text-[#373773]">
            ...
            <div className="text-center">
              <div className="grid grid-cols-2 gap-x-30 mt-40">
                <div className="max-w-[22.5rem] min-h-[8rem] py-8 px-26 bg-white rounded-20 flex justify-center items-center xs:text-12">
                  {' '}
          ...
          <div className="pl-30 md:pl-0">
            <div className="max-w-[26.25rem] font-medium text-26 leading-31 text-purple/70 xs:text-14 xs:leading-18 md:mt-24">
