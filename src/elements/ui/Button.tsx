...
const buttonPrimaryVariant =
  'text-white bg-[#FF7143] rounded-full text-20 font border-transparent hover:bg-[#C55B39] active:bg-[#FF9472]'
...
const buttonOrangeVariant =
  'bg-[#FF7143] rounded-31 border-0'
